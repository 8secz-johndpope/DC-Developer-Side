...
//---- hiding the stroke of progressBar = 0.0
        
//---- Unhiding the stroke of progressBar = 1.0
        //just for test to see what kind of color of prorgressBar Stroke
    ...
    fileprivate func gradientMask() -> CAGradientLayer {
        ...
        let colorTop: AnyObject = CustomColor.aquaBlue.cgColor
        let colorBottom: AnyObject = CustomColor.aquaBlue.cgColor
        let colorMiddle: AnyObject = CustomColor.red.cgColor
        let colorFinish: AnyObject = CustomColor.red.cgColor
    ...
    fileprivate func gradientMaskBg() -> CAGradientLayer {
        ...
        let colorTop: AnyObject = CustomColor.blackTranslucent.cgColor
        let colorBottom: AnyObject = CustomColor.blackTranslucent.cgColor
//-----Can add the color middle into the background and into the arrayOfColors
//        let colorMiddle: AnyObject = CustomColor.black.cgColor
        let arrayOfColors: [AnyObject] = [colorTop,colorBottom]
        gradientLayer.colors = arrayOfColors
